...
use super::{IndexedHeader, IndexedHeaderSingle, TreeNode};
...
impl<T: 'static> HeaderState<T> {
    ...
    */
    ...
    pub fn create_combined_sorter_fn(&self) -> SorterFn<TreeNode<T>> {
        ...
        SorterFn::new(move |a: &TreeNode<T>, b: &TreeNode<T>| {

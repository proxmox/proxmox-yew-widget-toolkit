...
impl Into<VTag> for Polyline {
    fn into(self) -> VTag {
        self.std_props.into_vtag(Cow::Borrowed("polyline"), Some(self.listeners), None)
    }
}
